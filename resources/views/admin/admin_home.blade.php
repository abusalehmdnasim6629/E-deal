...
<ul class="breadcrumb">
			...
			<div class="row-fluid">
				...
				<div class="span3 statbox purple" onTablet="span6" onDesktop="span3">
					...
					<div class="number"><?php $count = DB::table('tbl_manufacture')->count(); echo $count;?><i class="icon-arrow-up"></i></div>
					<div class="title">Total brand</div>
					<div class="footer">
						<a href="{{URL::to('/all-brand')}}"> read full report</a>
					</div>	
				</div>
				<div class="span3 statbox green" onTablet="span6" onDesktop="span3">
					
					<div class="number"><?php $count = DB::table('tbl_product')->count(); echo $count;?><i class="icon-arrow-up"></i></div>
					<div class="title">Total product</div>
					<div class="footer">
						<a href="{{URL::to('/all-product')}}"> read full report</a>
					</div>
				</div>
				<div class="span3 statbox blue noMargin" onTablet="span6" onDesktop="span3">
					
					<div class="number"><?php $count = DB::table('tbl_order')->count(); echo $count;?><i class="icon-arrow-up"></i></div>
					<div class="title">orders</div>
					<div class="footer">
						<a href="{{URL::to('/manage-order')}}"> read full report</a>
					</div>
				</div>
				<div class="span3 statbox yellow" onTablet="span6" onDesktop="span3">
					
					<div class="number"><?php $count = DB::table('tbl_customer')->count(); echo $count;?><i class="icon-arrow-down"></i></div>
					<div class="title">Total Customer</div>
					<div class="footer">
						<a href="{{URL::to('/all-customer')}}"> read full report</a>
					</div>
				</div>	
			...
			<div class="row-fluid">	
				...
				<a class="quick-button metro blue span2">
					...
					<p>Orders</p>
					<span class="badge"><?php $count = DB::table('tbl_order')->count(); echo $count;?></span>
				</a>
