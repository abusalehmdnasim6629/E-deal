		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="{{url::to('admin-dashboard')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email" id="username" type="text" placeholder="type email_address"/>
							</div>
					...
					<h3>If new?</h3>
					<p>
						No problem, <a href="{{url('/admin-register')}}">click here</a> to register.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
