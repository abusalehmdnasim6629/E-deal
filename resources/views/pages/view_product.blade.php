					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>{{$view_product->product_color}}</p>
								<img src="{{URL::to('frontend/images/product-details/rating.png')}}" alt="" />
								<span>
									<span>{{$view_product->product_price}} tk</span>
									<form action="{{url('/add-to-cart',$view_product->product_id)}}" method="post">
									{{ csrf_field() }}
										<label>Quantity:</label>
										<input name="qty" type="text" value="3" />
										<input name="product_id" type="hidden" value="{{$view_product->product_id}}" />
